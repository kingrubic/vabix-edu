...
export const metadata = createMetadata({
  title: "VABIX Trustworking",
  description: trustworking.summary,
  path: paths.trustworking,
});
...
export default function TrustworkingPage() {
  return (
    <>
      <PageHero
        eyebrow="VABIX TRUSTWORKING"
        title={trustworking.headline}
        description={trustworking.summary}
        crumbs={[{ name: "Trang chủ", href: "/" }, { name: "Trustworking" }]}
      />
      ...
      <section className="bg-vabix-ivory py-16">
        <Container className="grid gap-8 md:grid-cols-2">
          <article className="bg-white p-8" id="nha-cung-cap">
            <h2 className="text-2xl font-semibold text-vabix-deep-teal">Dành cho nhà cung cấp</h2>
          ...
          <article className="bg-white p-8" id="khach-hang">
            <h2 className="text-2xl font-semibold text-vabix-deep-teal">Dành cho khách hàng / đối tác</h2>
            <ul className="mt-5 list-disc space-y-2 pl-5 text-vabix-ink">
      ...
      <Container className="py-16" id="quy-trinh">
        <SectionHeading title="Quy trình Trustworking" />
      ...
      <section className="bg-vabix-ivory py-16" id="nguyen-tac">
        <Container>
          <SectionHeading title="Nguyên tắc Trustworking" />
      ...
      <Container className="py-16">
        ...
        <p className="mt-2 text-sm text-vabix-muted">Hồ sơ nhà cung cấp không đồng nghĩa chứng nhận pháp lý hay bảo đảm chất lượng tuyệt đối.</p>
      ...
      <section className="bg-vabix-ivory py-16" id="ket-noi">
        <Container>
          <SectionHeading title="Gửi nhu cầu kết nối" />
